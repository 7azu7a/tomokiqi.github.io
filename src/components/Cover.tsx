...
export const Cover = () => (
  ...
  >
    ...
    >
      ...
      />
      <Text>
        この「克く（よく）」は困難に耐え励む様を、「佳く（よく）」は形が整い美しい様を意味するそうです。
        ところでアジャイル開発原則のひとつに「技術的卓越性と優れた設計に対する不断の注意が機敏さを高める」という言葉があります。技術を克く学びプロダクトを佳く作ること。それが人々へ真に価値あるモノを届けることに繋がると私は考えます。
        私の強みは「最上志向」「学習欲」「慎重さ」です。これら資質はクリフトンストレングステストで気づくになる以前から、日々の仕事や趣味の中で自身感じていたものでもあります。私は自身の強みを以って克く学び佳く作ることで、人々に喜びや楽しさを届けることに努めていきます。
      </Text>
    </Box>
  </Flex>
);
